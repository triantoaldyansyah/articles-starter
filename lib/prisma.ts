...
const { TIDB_USER = '32cfaurj87qnidp.root', TIDB_PASSWORD = 'ItF0GyAN01WvdJGx', TIDB_HOST ='gateway01.us-east-1.prod.aws.tidbcloud.com', TIDB_PORT =4000, TIDB_DB_NAME = 'bookshop', DATABASE_URL } = process.env;
